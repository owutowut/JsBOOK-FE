  ...
  div.flex
    ...
    div.my-8.pt-8.pb-4.pl-8.bg-white.opacity-95.text-gray-800.w-full.h-full.mx-8.mt-6.rounded
      ...
      div.grid-cols-2.flex.pt-4.space-x-4.h-14.mt-2.ml-1
        button.btn.font-bold.py-2.px-4.rounded.items-center.shadow-md(class="hover:shadow-none" onclick="document.location='/Librarian/Edit/NewBooks'")
          span + เพิ่ม
        div.flex.space-x-2
            ...
            tbody(
              ...
              tr
                ...
                td.px-5.py-5.border.text-sm.border
                  .flex.space-x-3
                    a.text-center(:href="`/Librarian/View/Book/${book._id}` " title="title" class="text-blue-500") View
                    a.text-center(:href="`/Librarian/Edit/Books/${book._id}` " title="title" class="text-blue-500") Edit
                    button(class="text-red-500" @click="deletebooks(book._id)") Delete
</template>
