...
section.bg-silver
  div.flex
    ...
    div.my-8.pt-4.pb-4.pl-4.bg-white.opacity-95.text-gray-800.w-full.h-full.mx-8.mt-6.rounded-xl
        .text-black.text-xl.font-bold.border-b.border-grey-500 ข้อมูลหนังสือ
        .w-full.pl-8.pt-8.pr-12 
            .container
                form
                    .mb-4
