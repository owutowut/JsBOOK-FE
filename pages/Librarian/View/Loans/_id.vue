...
section.bg-silver
    ...
    div.flex
        ...
        div.my-8.pt-4.pb-4.pl-4.bg-white.opacity-95.text-gray-800.w-full.h-full.mx-8.mt-6.rounded-xl
            div.text-black.text-xl.font-bold.pl-6.pt-2 การยืม
            div.my-3
                hr
            .w-full.pl-8.pt-4
                .container
                    form
                        div.grid-cols-3.flex.space-x-8
                            div.space-y-3
                                .mb-4
                                ...
                                .mb-4
                                    ...
                                    p {{bname}}
                                .mb-4
                                    label.block.text-sm.font-bold.mb-2 อีเมล :
                                    p {{email}}
                                .mb-4
                                    label.block.text-sm.font-bold.mb-2 วันที่ยืม :
                                    p {{IsDate}}
                            div.space-y-3  
                                .mb-4
                                ...
                                .mb-4
                                    ...
                                    p(:class="`${status=='ล่าช้า'?' text-red-700 ':' text-green-700 '}`") {{status}}
                                .mb-4
                                    label.block.text-sm.font-bold.mb-2 วันที่คืน :
                                    p {{ReDate}}
                            div.space-y-3.ml-8  
                                label.ml-4.block.text-lg รูปภาพ 
                                    div.mt-4.space-y-4
